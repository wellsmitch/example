!function(e, t) {
    ...
    function B(e, t, n) {
        var r, i, o = 0, a = yt.length, s = ie.Deferred().always(function() {
            ...
            if (i)
                return !1;
            for (var t = pt || q(), n = Math.max(0, u.startTime + u.duration - t), r = n / u.duration || 0, o = 1 - r, a = 0, l = u.tweens.length; l > a; a++)
                u.tweens[a].run(o);
    ...
    var ue = function(e) {
        ...
        return d.prototype = T.filters = T.pseudos,
            ...
            S = t.select = function(e, t, n, r) {
                ...
                return (u || k(e, d))(r, t, !_, n, be.test(e) && c(t.parentNode) || t),
                    n
            }
            ,
...
!function() {
    function e(e) {
        if (!t) {
            ...
            l.push(a),
            "" === e.val() && e.val(a).addClass("placeholder"),
                e.focus(function() {
...
!function(e, t) {
    ...
    var r = function(e) {
        var t, n = "CHECK_STOARGE_TEST";
        try {
            return e.setItem(n, 1),
                t = e.getItem(n),
                e.removeItem(n),
            1 == t
        } catch (r) {
    ...
    try {
        t.isSessionAble = r(sessionStorage),
            t.isLocalAble = r(localStorage)
    } catch (i) {
        t.isSessionAble = !1,
            t.isLocalAble = !1
    }
    var a = {
        ...
        getAll: function() {
            try {
                return this.data = t.parseJSON(window.name || "{}")
            } catch (e) {
                return this.data = {}
            }
        },
        setItem: function(e, n) {
            var r = this.data || this.getAll();
            t.isPlainObject(r) || (r = {}),
                r[e] = n,
                this._flush(r)
        },
        getItem: function(e) {
            var n = this.data || this.getAll();
            if (t.isPlainObject(n))
                return n[e]
        },
        removeItem: function(e) {
            var n = this.data || this.getAll();
            t.isPlainObject(n) && (delete n[e],
                this._flush(n))
        }
    }
        , o = function(e, n) {
        e = e || "session",
            n = n || "STORAGE_NAMESPACE";
        var r, i, o, s = 40, l = 0, c = 864e5, u = {
            local: function(e) {
                return t.isLocalAble ? [t.parseJSON(localStorage.getItem(e) || "{}"), localStorage] : [{}, {
                    setItem: function() {}
                }]
            },
            session: function(e) {
                return t.isSessionAble ? [t.parseJSON(sessionStorage.getItem(e) || "{}"), sessionStorage] : this.name(e)
            },
            name: function(e) {
                return [a.getItem(e), a]
            },
            storage: function(e) {
                return t.isLocalAble ? [t.parseJSON(localStorage.getItem(e) || "{}"), localStorage] : this.session(e)
            }
        };
        r = u[e](n),
            o = r[0],
        ...
        var f = function(e, t) {
            ...
            var n = o[e]
                , r = n && n.v;
            return t.isPlainObject(r) ? t.extend(!0, {}, r) : t.isArray(r) ? t.extend(!0, [], r) : r
        }
            , p = function(e) {
            l = s,
                delete o[e],
    ...
    var s = {
        ...
        , c = function(e) {
        return e.push(""),
            new RegExp("(^|&|\\?)(t=|_t=|" + e.join("=|") + ")([^&]*)(&|$)","i")
    }
        , u = function(e) {
        var n = e.url
            , r = e.filterProp || e.filter
            , i = n + (n.indexOf("?") > -1 ? "&" : "?") + (e.data || "");
        return r ? t.isArray(r) ? i.replace(c(r), "") : i.replace(l, "") : i
    }
        , f = function(e, n) {
        if (e) {
            if (401 === e.status && e.responseText)
                try {
                    var r = JSON.parse(e.responseText);
                    r && r.login_url && (top.window.location.href = r.login_url)
                } catch (i) {}
            if (403 === e.status && e.responseText)
                try {
                    var r = JSON.parse(e.responseText);
                    r && t.topTips({
                        mode: "warning",
            ...
            "canceled" !== n && s.error.apply(this, arguments)
        }
    }
        , h = function(e, n, r) {
        var i = s.then.apply(this, arguments);
        return "boolean" !== t.type(i) || i ? t.Deferred().resolve(e, n, r) : t.Deferred().reject(r, n, "logic error")
    };
    t.ajaxDelay = 300,
    t.ajaxPrefilterHook || (t.ajaxPrefilterHook = !0,
        t.ajaxPrefilter(function(e, n, r) {
            var i = e.beforeSend;
            e.beforeSend = function(e, n) {
                var r = !0;
                if (i && (r = i(e, n),
                    r = r || void 0 === r),
                r && n.async && !n.repeat) {
                    var a = u(n)
                        , o = n.node ? t(n.node) : t()
                        , l = n.process || "btn-loading";
                    if (o.length && (o.find(".icon-loading").length || o.prepend('<span class="icon-loading">'),
                        o.hasClass(l)))
                        return s.cancel.apply(this, arguments),
                            !1;
                    if (s[a]) {
                        if (!n.abort)
                            return s.cancel.apply(this, arguments),
                    ...
                    s[a] = e.always(function() {
                        o.removeClass(l),
                            setTimeout(function() {
                                delete s[a]
                            }, n.abort ? 0 : void 0 === n.ajaxDelay ? t.ajaxDelay : n.ajaxDelay)
                    }),
                        o.addClass(l)
                }
                return r
    ...
    var p = {
        ...
        ajaxEx: function(e) {
            ...
            return e = e || {},
                ...
                s.then ? t.ajax(e).then(h).fail(f) : t.ajax(e).fail(f)
        },
        ajaxSetup: function(e, n) {
            var r = {}
                , i = t.type(e);
            "string" === i ? r[e] = n : "object" === i && (r = e),
                t.extend(s, r)
        },
        getQueryStr: function(e, t) {
            var n = new RegExp("(^|&|\\?)" + e + "=([^&]*)(&|$)","i")
                , r = (t || location.search.substr(1)).match(n);
        ...
        format: function(e, t) {
            ...
            return e.replace(/\{([^{}]+)\}/g, function(e, r) {
                var i = t[r];
                return void 0 !== i ? n.xss("" + i) : e
            })
        },
        getQuery: function(e, t, n, r) {
            var i, a, o = t || location.search.replace("?", ""), s = {}, l = o.split("&"), c = l.length;
            if (c > 0)
                for (var u = 0; u < c; u++)
                    try {
                        2 === (i = l[u].split("=")).length && (a = r ? i[1] : decodeURIComponent(i[1]),
                            s[i[0]] = n ? a : this.xss(a))
                    } catch (f) {}
            return e ? s[e] : s
        },
        ie: function() {
        ...
        _getElesByForm: function(e) {
            var n = e.elements || e.find("input, select, textarea")
                , r = {
                file: !1,
                submit: !1,
                reset: !1,
            ...
            return n = t.grep(n, function(e) {
                return r[t(e).attr("type") + ""] !== !1
            })
        },
        _getValue: function(e) {
            var n = e.attr("type")
                , r = t.trim(e.val());
            return "checkbox" != n && "radio" != n || (r = e.prop("checked") ? r : void 0),
                r
        },
        _readProperty: function(e) {
            e = t(e);
            var n = {
                id: e.attr("id"),
        ...
        serialize: function(e, n) {
            n = void 0 == n ? 1 : n;
            var r, i = this._getElesByForm(e), a = this, o = 1 == n ? [] : {};
            return t.each(i, function(e, t) {
                r = a._readProperty(t),
                void 0 !== r.value && (1 == n ? o.push(r.name + "=" + r.value) : o[r.name] = r.value)
            }),
                1 == n ? o.join("&") : o
        },
        compare: function(e, t) {
            var n, r = arguments[2] || [!0];
            e = e || {},
                t = t || {};
            for (n in e) {
                ...
                if ("object" == typeof e[n])
                    arguments.callee(e[n], t[n], r) && arguments.callee(t[n], e[n], r);
                else if (e[n] !== t[n])
                    return r.push(!1),
                        !1
            }
        ...
        path: function(e, n, r) {
            var i, a = "", o = "/" + this.getToken() + ("/" === e.charAt(0) ? "" : "/");
            i = e.indexOf("#"),
            i !== -1 && (a = e.substring(i),
                e = e.substring(0, i)),
            t.isPlainObject(n) && (n = t.param(n));
            var s = this.getQueryStr("_ac")
                , l = "";
            s && (l = n ? n + "&" : "",
                n = l + "_ac=" + s);
            var c = this.getQueryStr("_fc");
            if (c && (l = n ? n + "&" : "",
                n = l + "_fc=" + c),
            ...
            r !== !1) {
                r !== !0 && (l = n ? n + "&" : "",
                    n = l + "_smp=" + r);
                var u = this.getQueryStr("_smp");
                u && r === !0 && (l = n ? n + "&" : "",
                    n = l + "_smp=" + u)
            }
            return n = n ? (e.indexOf("?") !== -1 ? "&" : "?") + n : "",
            o + e + n + a
        },
        unparam: function(e, n) {
            if ("string" != typeof e)
                return e;
            if (0 === (e = t.trim(e)).length)
                return {};
            for (var r, i, a, o, s = {}, l = e.split(n || "&"), c = 0, u = l.length; c < u; c++) {
                r = l[c].split("="),
        ...
        image: function(e, t, n, r) {
            return r = r ? r : 100,
                t && n ? [e, "?x-oss-process=image/resize,m_lfit", ",w_" + t, ",h_" + n, "/quality,Q_" + r, "/format,png"].join("") : e
        },
        Rebuild: {
            _lastSheet: function() {
                var e = document.styleSheets
                    , t = e[e.length - 1].ownerNode;
                return t
            }(),
            css: function(e, n) {
                var r = t("<style type='text/css' " + (n ? "id='" + n + "'" : "") + ">" + e + "</style>");
                if (this._lastSheet)
                    r.insertBefore(this._lastSheet);
                else {
                    var i, a = t("head"), o = a.find("link"), s = o.length;
                    s > 0 ? r.insertAfter(o.eq(0)) : (i = a.find("style"),
                        i.length > 0 ? r.insertBefore(i.eq(0)) : a.append(r))
                }
                return this
            }
        }
    };
    p.o = document.getElementsByName("prefix")[0] && document.getElementsByName("prefix")[0].content,
        e.Overall = e.O = e.Util = p,
        t.sessionOfTenant = o("session", p.getToken()),
        e.__REQUIRE = function(e) {
            function t() {
                seajs.use(e)
            }
            function r() {
                n(e.replace("modules", "modules/build"))
            }
            var i = Util.getQueryStr("run");
            "dev" == window.ENV || "debug" == i ? "build" == i ? r() : t() : r()
        }
...
!function(e, t) {
    ...
    function u(e) {
        var t, r = b.paths;
        return r && (t = e.match(G)) && T(r[t[1]]) && (e = r[t[1]] + t[2]),
            e
    }
    function c(e) {
        var t = b.vars;
    ...
    function f(e) {
        ...
        if (t)
            for (var n = 0, a = t.length; n < a; n++) {
                var i = t[n];
                if (r = w(i) ? i(e) || e : e.replace(i[0], i[1]),
                r !== e)
                    break
            }
        return r
    ...
    function p(e, t, r) {
        ...
        return n ? void setTimeout(function() {
            g(e, t)
                ...
                W.test(e.readyState) && (e.onload = e.onerror = e.onreadystatechange = null,
                r || b.debug || M.removeChild(e),
                    e = null,
                    t())
            }
        )
    ...
    if (!e.seajs) {
        ...
        y.prototype.resolve = function() {
            for (var e = this, t = e.dependencies, r = [], n = 0, a = t.length; n < a; n++)
                r[n] = y.resolve(t[n], e.uri);
            return r
        }
            ,
            y.prototype.load = function() {
                ...
                if (!(e.status >= re.LOADING)) {
                    ...
                    var t = e.resolve();
                    j("load", t);
                    for (var r, n = e._remain = t.length, a = 0; a < n; a++)
                        r = y.get(t[a]),
                    ...
                    for (a = 0; a < n; a++)
                        r = Q[t[a]],
                            r.status < re.FETCHING ? r.fetch(i) : r.status === re.SAVED && r.load();
                    for (var s in i)
            ...
            y.prototype.fetch = function(e) {
                ...
                return !s || ee[s] ? void n.load() : Z[s] ? void te[s].push(n) : (Z[s] = !0,
                    te[s] = [n],
                    j("request", i = {
                        uri: a,
                        requestUri: s,
            ...
            y.prototype.exec = function() {
                ...
                e.resolve = function(e) {
                    ...
                    e.async = function(t, r) {
                        return y.use(t, r, a + "_async_" + n()),
                            e
                    }
                    ,
                    e.ensure = function(t, r) {
                        return r(e)
                    }
                ;
                var i = r.factory
                    , s = w(i) ? i(e, r.exports = {}, r) : i;
                return s === t && (s = r.exports),
                null !== s || K.test(a) || j("error", r),
                    delete r.factory,
                    r.exports = s,
            ...
            y.use = function(t, r, n) {
                ...
                a.callback = function() {
                    for (var t = [], n = a.resolve(), i = 0, s = n.length; i < s; i++)
                        t[i] = Q[n[i]].exec();
                    r && r.apply(e, t),
                        delete a.callback
                }
            ...
            _.config = function(e) {
                for (var t in e) {
                    ...
                    if (n && A(n))
                        ...
                        D(n) ? r = n.concat(r) : "base" === t && ("/" === r.slice(-1) || (r += "/"),
                            r = l(r)),
                            b[t] = r
                }
                return j("config", e),
...
seajs.config({
    alias: {
        jquery: "/frontend/js/lib/jquery/jquery-1.11.2.min.js",
        underscore: "/frontend/js/lib/backbone/underscore.js",
        backbone: "/frontend/js/lib/backbone/backbone.js",
        template: "/frontend/js/lib/template.js",
        tooltips: "/frontend/js/lib/tooltips/tooltips.js",
        dialog: "/frontend/js/lib/dialog.js",
        tab: "/frontend/js/plugin/tab.js",
        grid: "/frontend/js/plugin/grid.js",
        map: "/frontend/js/plugin/map.js?v=201802021039",
        uploadig: "/frontend/js/plugin/uploadimg.js",
        ueditor: "/frontend/js/plugin/ueditor.js",
        form: "/frontend/js/plugin/form.js",
        laydate: "/frontend/3rd/laydate/laydate.js",
        "dialog-message": "/frontend/js/funjs/dialog-message/dialog-message-min.js"
    }
});
function redirectLogin(event) {
    if (event.data) {
        ...
        if ("redirectLogin" == data.dataType) {
...
!function(t) {
    ...
    e.XDStorage = function(t, e) {
        ...
        e.XDStorage.prototype = {
            ...
            getValueAjax: function(t, e) {
                this._toSend({
                    op: this.op.AJAXGET,
                    url: t.url
                }, e)
            },
            setValue: function(t, e, a) {
                this._toSend({
                    key: t,
                    op: this.op.WRITE,
                    value: e
            ...
            _sendRequest: function(t) {
                this._requests[t.request.id] = t,
                    this._iframe.contentWindow.postMessage(JSON.stringify(t.request), this.origin)
            },
            _iframeLoaded: function() {
                if (this._iframeReady = !0,
                    this._queue.length) {
                    for (var t = 0, e = this._queue.length; t < e; t++)
                        this._sendRequest(this._queue[t]);
                    this._queue = []
                }
            },
            _handleMessage: function(t) {
                if (t.origin == this.origin && "string" == typeof t.data) {
                    var e = JSON.parse(t.data);
                    this._requests && this._requests[e.id].callback && this._requests[e.id].callback(e.key, e.value),
                        delete this._requests[e.id]
                }
            }
        };
    var a = {
        ...
        ENV: "pro",
        hostList: [{
            one: "app-test.myyscm.com",
            two: ["app-test.myyscm.com", "wx-test.myyscm.com", "zj-test.myyscm.com", "yf-test.myyscm.com", "kefu-test.myyscm.com", "member-test.myyscm.com", "property-test.myyscm.com", "pb-test.myyscm.com"]
        }, {
            one: "bms.myfuwu.com.cn",
            two: ["pb.myysq.com.cn", "property.myysq.com.cn", "member.myysq.com.cn", "kefu.myysq.com.cn", "yf.myysq.com.cn", "zj.myysq.com.cn", "wx.myysq.com.cn", "bms.myfuwu.com.cn"]
        }, {
            one: "bms-beta.myfuwu.com.cn",
            two: ["bms-beta.myfuwu.com.cn", "wx-beta.myysq.com.cn", "zj-beta.myysq.com.cn", "yf-beta.myysq.com.cn", "kefu-beta.myysq.com.cn", "member-beta.myysq.com.cn", "property-beta.myysq.com.cn", "pb-beta.myysq.com.cn"]
        }],
        host: "",
        Protocol: "",
        data: [{
            ...
            num: "10",
            dead: "三月",
            end_date: "2017年10月20日",
            name: "name"
        }, {
            type: "MobileCheckRoom",
            room_num: "20"
        }],
        dialogHtmlTpl: '<div class="_dialog_title"><span class="glyphicon glyphicon-remove _dialog_action" id="_dialog_action_close"></span></div><div class="_dialog_top"><div class="_dialog_content">亲爱的用户，您好：</div></div><div id="_dialog_content"></div><div class="_dialog_top"><div class="_dialog_content">请尽快联系明源客户经理或‘点我咨询’进行续期！</div></div><div class="_dialog_button_bottom" id="_dialog_button_bottom">知道了，不提醒</div>',
        dialogHtmlMobileCheckRoom: '<div class="_dialog_top"><div class="_dialog_content">__app_name的剩余房间数___room_num</div></div>',
        dialogHtmlCompany: '<div class="_dialog_top"><div class="_dialog_content"><u class="_text_underline">__name的__app_name将于<span class="_dialog_time">__end_date</span>到期，租期已不足__dead，若到期未续约，将影响到__name__app_name的使用___num</u></div></div>',
        dialogHtmlProject: '<div class="_dialog_top"><div class="_dialog_content"><u class="_text_underline">__name项目将于<span class="_dialog_time">__end_date</span>到期，租期已不足__dead，若到期未续约，将影响到__name项目在__app_name产品中的使用___num</u></div></div>',
        dialogHtmlTenant: '<div class="_dialog_top"><div class="_dialog_content"><u class="_text_underline">__app_name将于<span class="_dialog_time">__end_date</span>到期，租期已不足__dead，若到期未续约，将影响__app_name使用!</u></div></div>',
        dialogHtmlDeadTenant: '<div class="_dialog_top"><div class="_dialog_content"><u class="_text_underline">__app_name已于<span class="_dialog_time">__end_date</span>到期</u></div></div>',
        dialogHtmlDeadCompany: '<div class="_dialog_top"><div class="_dialog_content"><u class="_text_underline">__name的__app_name已于<span class="_dialog_time">__end_date</span>到期___num</u></div></div>',
        dialogHtmlDeadProject: '<div class="_dialog_top"><div class="_dialog_content"><u class="_text_underline">__app_name的__name已于<span class="_dialog_time">__end_date</span>到期___num</u></div></div>',
        dialogCheckMore: '<div class="_dialog_top" style="padding: 0px 0 15px 22px;margin-top: -19px;"><a style="font-size: 15px; cursor: pointer;" id="__dialog_check_more">查看更多</a></div>',
        dialogHeadTpl: '<div class="grid padding" style="margin:15px 20px;">    <div class="grid-content" id="grid">        <table class="table form">            <thead>            <tr class="bg-gray">                <th width="50" style="text-align: center;">序号</th>                <th width="120" style="text-align: center;">产品</th>                <th width="120" style="text-align: center;">公司项目</th>                <th width="80" style="text-align: center;">状态</th>                <th width="120" style="text-align: center;">起租日期</th>                <th width="120" style="text-align: center;">到期日期</th>            </tr>            </thead>            <tbody>',
        dialogBodyTpl: "</tbody>        </table></div>",
        dialogFooterHeadTpl: '<div style="margin: 30px;">        <div>',
        dialogFooterBodyTpl: '<span type="button" class="btn btn-primary" style="float:right; display: none;" id="__dialog_nerver_notice">不再提醒</span>        </div>        <div style="margin-top: 15px;">请尽快联系明源客户经理或‘点我咨询’进行续期！</div>    </div>    </div>',
        url: "/bms/applicationAuth/app-auth/check-auth",
        __getQueryString: function(t) {
            var e = new RegExp("(^|&)" + t + "=([^&]*)(&|$)","i")
                , a = window.location.search.substr(1).match(e);
            return null != a ? unescape(a[2]) : ""
        },
        __getCheckAuthUrl: function() {
            var t = $(".manage-header").find(".user-name").data("user")
                , e = this.__getQueryString("_ac")
                , a = this.__getQueryString("_smp");
            return "test" == window.ENV || "dev" == window.ENV ? "https://app-test.myyscm.com/bms/applicationAuth/app-auth/check-auth?_ac=" + e + "&_smp=" + a + "&o=" + t : "beta" == window.ENV ? "https://bms-beta.myfuwu.com.cn/bms/applicationAuth/app-auth/check-auth?_ac=" + e + "&_smp=" + a + "&o=" + t : "https://bms.myfuwu.com.cn/bms/applicationAuth/app-auth/check-auth?_ac=" + e + "&_smp=" + a + "&o=" + t
        },
        expire_list_url: "/bms/applicationAuth/app-auth/remind-list",
        __getEpireListUrl: function() {
            var t = $(".manage-header").find(".user-name").data("user")
                , e = this.__getQueryString("_ac")
                , a = this.__getQueryString("_smp");
            return "test" == window.ENV || "dev" == window.ENV ? "https://app-test.myyscm.com/bms/applicationAuth/app-auth/remind-list?_ac=" + e + "&_smp=" + a + "&o=" + t : "beta" == window.ENV ? "https://bms-beta.myfuwu.com.cn/bms/applicationAuth/app-auth/remind-list?_ac=" + e + "&_smp=" + a + "&o=" + t : "https://bms.myfuwu.com.cn/bms/applicationAuth/app-auth/remind-list?_ac=" + e + "&_smp=" + a + "&o=" + t
        },
        __dialog_ajax: {
            get: function(t, e) {
                ...
                a.open("GET", t, !0),
                    a.onreadystatechange = function() {
                        (4 == a.readyState && 200 == a.status || 304 == a.status) && e.call(this, a.responseText)
                    }
                    ,
                    a.send(null)
            },
            post: function(t, e, a) {
                ...
                n.open("POST", t, !0),
                    ...
                    n.onreadystatechange = function() {
                        4 != n.readyState || 200 != n.status && 304 != n.status || a.call(this, n.responseText)
                    }
                    ,
                    n.send(e)
            }
        },
        __getDialogInfoMsg: function() {
            var t = this;
            this.remoteStorage.getValueAjax({
                url: this.__getCheckAuthUrl()
            }, function(e, a) {
                if ("string" == typeof a) {
                    var n = JSON.parse(a);
                    if (n.status && n.data.length > 0) {
                        var i = document.createElement("link");
                        i.rel = "stylesheet",
                            i.href = "/frontend/js/funjs/dialog-message/dialog-message.css";
                        var o = document.getElementsByTagName("link")[0];
                        o.parentNode.insertBefore(i, o),
                            t.__dialogHandleData(n)
                    }
                }
            })
        },
        __getJsonpMsgData: function() {
            var t = this;
            $.ajax({
                url: t.__getCheckAuthUrl(),
                dataType: "jsonp",
                jsonp: "_callback",
                type: "get",
                async: !1,
                ...
                success: function(e) {
                    ...
                    a.status && a.data.length > 0) {
                        var n = document.createElement("link");
                        n.rel = "stylesheet",
                            n.href = "/frontend/js/funjs/dialog-message/dialog-message.css";
                        var i = document.getElementsByTagName("link")[0];
                        i.parentNode.insertBefore(n, i),
                            t.__dialogHandleData(a)
                    }
                },
                error: function(t) {
                    console.log(t)
        ...
        __dialogHandleData: function(t) {
            var e = this
                , a = ""
                , n = "";
            if (t.data.length > 0) {
                for (var i = 0; i < t.data.length; i++)
                    "sms" != t.data[i].type && ("dead" !== t.data[i].dead ? "tenant" === t.data[i].type ? a = this.dialogHtmlTenant : "company" === t.data[i].type ? (a = this.dialogHtmlCompany,
                        a = t.data[i].num > 1 ? a.replace("___num", '，总共有<span class="_dialog_time">__num</span>个公司快到期') : a.replace("___num", "")) : "project" === t.data[i].type ? (a = this.dialogHtmlProject,
                        a = t.data[i].num > 1 ? a.replace("___num", '，总共有<span class="_dialog_time">__num</span>个项目即将到期') : a.replace("___num", "")) : "MobileCheckRoom" === t.data[i].type && (a = this.dialogHtmlMobileCheckRoom,
                        a = 1 * t.data[i].room_num === 0 ? a.replace("___room_num", '为<span class="_dialog_time">0</span>') : a.replace("___room_num", '已不足<span class="_dialog_time">__room_num</span>')) : "tenant" === t.data[i].type ? a = this.dialogHtmlDeadTenant : "company" === t.data[i].type ? (a = this.dialogHtmlDeadCompany,
                        a = t.data[i].num > 1 ? a.replace("___num", '，总共有<span class="_dialog_time">__num</span>个公司到期！') : a.replace("___num", "")) : "project" === t.data[i].type && (a = this.dialogHtmlDeadProject,
                        a = t.data[i].num > 1 ? a.replace("___num", '，总共有<span class="_dialog_time">__num</span>个项目到期！') : a.replace("___num", "")),
                        n += a.replace(/__app_name/g, t.data[i].app_name).replace("__room_num", t.data[i].room_num).replace(/__name/g, t.data[i].name).replace("__end_date", t.data[i].end_date).replace("__dead", t.data[i].dead).replace("__num", t.data[i].num));
                n.length > 12 && t.data && t.data.length && $("body").on("click", "._text_underline", e.__checkMoreHandle.bind(this)),
                    this.__dialogInitHtml(n)
            }
        },
        __dialogInitHtml: function(t) {
            var e = this
                , a = new Date
                , n = a.getFullYear() + "-" + ("0" + (a.getMonth() + 1)).slice(-2) + "-" + ("0" + a.getDate()).slice(-2)
                , i = document.createElement("div");
            i.className = "_dialog_continue",
                i.id = "_dialog_continue",
                document.body.appendChild(i),
                document.querySelector("#_dialog_continue").innerHTML = this.dialogHtmlTpl,
                document.querySelector("#_dialog_content").innerHTML = t,
                document.querySelector("#_dialog_continue").style.display = "inline-block",
                document.querySelector("#_dialog_action_close").onclick = function() {
                    e.__hideHtml(e)
                }
                ,
                document.querySelector("#_dialog_button_bottom").onclick = function() {
                    document.querySelector("#_dialog_continue").style.display = "none",
                        e.remoteStorage.setValue(e.userCode + "__local_dialog", JSON.stringify({
                            type: "month",
                            date: n
                        }))
                }
        ...
        __hideHtml: function(t) {
            var e = new Date
                , a = e.getFullYear() + "-" + ("0" + (e.getMonth() + 1)).slice(-2) + "-" + ("0" + e.getDate()).slice(-2);
            document.querySelector("#_dialog_continue").style.display = "none",
                t.remoteStorage.setValue(t.userCode + "__local_dialog", JSON.stringify({
                    type: "day",
                    date: a
                }))
        },
        ...
        init: function() {
            var t = new Date
                , a = t.getFullYear() + "-" + ("0" + (t.getMonth() + 1)).slice(-2) + "-" + ("0" + t.getDate()).slice(-2)
                , n = window.document.domain;
            this.Protocol = "https:";
            var i = document.querySelector("meta[name='prefix']") ? document.querySelector("meta[name='prefix']").content : ""
                , o = document.querySelector(".mr14 > .user-name") ? document.querySelector(".mr14 > .user-name").getAttribute("data-user") : "";
            if (i && o) {
                if (this.userCode = i + "_" + o,
                "dev" === this.ENV)
                    this.Protocol = "http:",
                        this.host = this.hostList[0].one;
                else
                    for (var s in this.hostList)
                        if (this.hostList[s].two.join("").indexOf(n) >= 0) {
                            this.host = this.hostList[s].one;
                            break
                        }
                if (this.host) {
                    this.remoteStorage = new e.XDStorage(this.Protocol + "//" + this.host,"/frontend/js/funjs/dialog-message/proxy.html");
                    var l = this;
                    this.remoteStorage.getValue(this.userCode + "__local_dialog", function(t, e) {
                        var n = e;
                        n ? n && ("string" == typeof n && (n = JSON.parse(n)),
                            "day" === n.type ? l.dateDiff(a, n.date) >= 1 && l.__getJsonpMsgData() : "month" === n.type && l.dateDiff(a, n.date) >= 30 && l.__getJsonpMsgData()) : l.__getJsonpMsgData()
                    })
                }
            }
        },
        dateDiff: function(t, e) {
            ...
            return a = t.split("-"),
                ...
                a = e.split("-"),
                i = new Date(a[1] + "-" + a[2] + "-" + a[0]),
                o = parseInt(Math.abs(n - i) / 1e3 / 60 / 60 / 24)
        },
        __checkMoreHandle: function() {
            var t = this;
            $.ajax({
                url: t.__getEpireListUrl(),
                dataType: "jsonp",
                jsonp: "_callback",
                type: "get",
                async: !1,
                ...
                success: function(e) {
                    ...
                    a.status && a.data && a.data.warning.length && t.__getDialogTableHtml.call(t, a, t.dialogHeadTpl)
                },
                error: function(t) {
                    console.log(t)
                }
        ...
        __getDialogTableHtml: function(t, e) {
            var a = this
                , n = ""
                , i = t.data.warning
                , o = t.data.room_warning;
            i.forEach(function(t, e) {
                n += "<tr>",
                    n += '<td style="text-align: center;" title="' + e + '">' + (+e + 1) + "</td>",
                    n += '<td style="text-align: center;" title="' + t.app_name + '">' + t.app_name + "</td>",
                    n += '<td style="text-align: center;" title="' + t.name + '">' + (t.name ? t.name : "") + "</td>",
                    n += "dead" == t.dead ? '<td style="text-align: center;color:red;" title="已过期"> 已过期 </td>' : '<td style="text-align: center;color: blue;" title="即将过期"> 即将过期 </td>',
                    n += '<td style="text-align: center;" title="' + t.start_date + '">' + a.convertDate(t.start_date) + "</td>",
                    n += '<td style="text-align: center;" title="' + t.end_date + '">' + a.convertDate(t.end_date) + "</td>",
                    n += "</tr>"
            }),
                e += n,
                e += a.dialogBodyTpl,
                e += a.dialogFooterHeadTpl,
            o && o.length && (e += a.__getDialogFooterHtml(o)),
                e += a.dialogFooterBodyTpl;
            $.box && $.box({
                content: e,
                title: "产品租期即将到期提醒",
                height: "auto",
        ...
        __getDialogFooterHtml: function(t) {
            var e = t.length
                , a = "";
            return t.forEach(function(t, n) {
                a += n != e - 1 ? '<span style="display: block">' + t.app_name + ' 产品现剩余 <span style="color:  red;margin: 0 5px;">' + t.room_num + "</span>个房间数</span>" : "<span>" + t.app_name + ' 产品现剩余 <span style="color:  red;margin: 0 5px;">' + t.room_num + "</span>房间数</span>"
            }),
                a
        },
        convertDate: function(t) {
            return t.length > 11 ? t.slice(0, 11).replace("年", "-").replace("月", "-").replace("日", "") : t
        }
    };
    a.init()
}();
